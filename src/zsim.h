...
struct GlobSimInfo {
    ...
    volatile bool maxOffloadInstrsIssued;
    ...
    ramulator::ZsimWrapper* ramulatorWrapper;
    ramulator::Config* ramulatorConfigs;
    MemType mem_type;
    uint32_t heartbeatInterval;
    HeartBeat* heartBeats;
    MemoryMapper* memoryMapper;
    /**----- TLB and memory management related-----**/
	...
	unsigned mem_access_time; // including page allocating

    unsigned deadlock_killing_cycles;
    //PIM related
    bool enable_pim_mode;
    
    bool skipNonOffloadBBL;

    bool nonCacheable;
    WritePolicy cacheWritePolicy;

    bool dataMemNetworkNoLatency;
    bool ptwMemNetworkNoLatency;
};
