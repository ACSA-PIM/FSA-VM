...
class BuddyAllocator {
  ...
  private:
    ...
    Page *rmqueue_page_smallest(MemoryNode *mem_node, Zone *zone,
                                unsigned order);
    void expand(MemoryNode *mem_node, Zone *zone, uint64_t page_id,
                unsigned low_order, unsigned high_order);
    void expand(MemoryNode *mem_node, Zone *zone, uint64_t head_page_id,
                uint64_t page_id, unsigned low_order, unsigned high_order);
